...
\begin{itemize}
  ...
  \item \textbf{The shipped test suites.} Every component you implement comes with a unit-test
    suite written against the PihlCore Test framework. They tell you \emph{whether} you are right
...
\begin{shell}
git clone --recursive https://github.com/pihlcore/analog-electronics.git
\end{shell}
